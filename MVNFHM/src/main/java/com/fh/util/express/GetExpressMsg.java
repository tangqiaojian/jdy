...
public class GetExpressMsg {
    ...
    private final static String APP_KEY = "24935517";
    // APP密钥	 参数二 （阿里巴巴支付后获得）
    private final static String APP_SECRET = "20050895c935cd136dcec92ea5cf6cdb";
    //API域名
    ...
    public static void main(String[] args) throws Exception {
    	...
    	String  str=GetExpressMsg.get("3953931251993");
