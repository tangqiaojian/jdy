...
public class UserController extends BaseController {
	...
	public ModelAndView listUsers(Page page)throws Exception{
		...
		PageData roleDate=new PageData();
		roleDate.put("ROLE_ID", "1");
		List<Role> roleList = roleService.listAllRolesByPId(roleDate);//列出所有系统用户角色
	...
	public ModelAndView goAddU()throws Exception{
		...
		List<PageData> stores=storeService.listAll(pd); //列出门店列表
