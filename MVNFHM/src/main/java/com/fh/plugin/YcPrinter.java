...
public class YcPrinter {
	...
	public void printer() {
		...
		try {
			...
			paper.setImageableArea(10,10, 590,840);// A4(595 X 842)设置打印区域，其实0，0应该是72，72，因为A4纸的默认X,Y边距是72
			pf.setPaper(paper);
	...
	public Prient getPrient() {
		return prient;
	}

	public void setPrient(Prient prient) {
		this.prient = prient;
	}
