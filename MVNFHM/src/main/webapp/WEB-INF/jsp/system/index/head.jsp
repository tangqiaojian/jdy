<div id="navbar" class="navbar navbar-default" style="background-color: #536980">
	...
	<div class="navbar-container" id="navbar-container">
		...
		<div class="navbar-header pull-left">
			...
			<a class="navbar-brand">
				<img src="static/ace/avatars/logo.png" style="display: inline"/>
				<small> <!-- <i class="fa fa-leaf"></i> -->
					<c:choose>
						<c:when test="${ pd.urole.ROLE_ID eq '1' || pd.urole.ROLE_ID eq '6275ea7c472f4a73943e29b08ee6ce55' || pd.urole.ROLE_ID eq '7b44c58a806d4034a8c15ca28a0d53fc' || pd.urole.ROLE_ID eq  'b1b904828b2e481c9393fb034124ff5d'}">
							${pd.SYSNAME}
						</c:when>
						<c:when test="${pd.urole.ROLE_ID eq 'a809f300d155452680a8760ec8592408' }">
							筋斗云门店端
						</c:when>
						<c:otherwise>
							筋斗云用户端
		...
		<div class="navbar-buttons navbar-header pull-right" role="navigation">
			<ul class="nav ace-nav">
				...
				<li style="margin-right: 2.5em;height: 55px">
							<span  id="user_info" style="font-size: 1em;font-weight: bold;color: #c5c9d5">

								</span>
				</li>
				<li style="color:black;border-left: 0px;height: 55px;">
					<a data-toggle="dropdown"  class="dropdown-toggle" href="#" style="padding-top: 3px">
						<img class="img-circle" src="static/ace/avatars/userde.jpg" alt="Jason's Photo" id="userPhoto" />
