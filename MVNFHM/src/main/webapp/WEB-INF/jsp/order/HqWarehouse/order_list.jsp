			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="HqWarehouse/list_cursor_order.do" method="post" name="Form" id="Form">
												...
												<div class="hidden-sm hidden-xs btn-group">
													<c:choose>
													  <c:when test="${var.STATEA=='0'}">
													    <a class="btn btn-xs btn-success" title="查看" onclick="details" href="<%=basePath%>storeOrder/order_store_details_0.do?ORDER_ID=${var.ORDER_ID}" >
														      查看
													    </a>
													  </c:when>
													  <c:otherwise>
													...
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<c:choose>
													            <c:when test="${var.STATEA=='0'}">
													              <li>
																    <a style="cursor:pointer;" href="<%=basePath%>storeOrder/order_store_details_0.do?ORDER_ID=${var.ORDER_ID}"  class="tooltip-success" data-rel="tooltip" title="修改">
																	 <span class="green">
																		 查看
																	   </span>
																     </a>
													            ...
													            <c:otherwise>
													                <li>
																    <a style="cursor:pointer;" href="<%=basePath%>order/order_1_details.do?ORDER_ID=${var.ORDER_ID}"  class="tooltip-success" data-rel="tooltip" title="修改">
																	 <span class="green">
																		 查看
																	   </span>
																     </a>
					      ...
					      <table id="table_report_3" class="table table-striped table-bordered table-hover">
					          <tr>
					           <td style="text-align: center;" colspan="10">
							     <a class="btn btn-mini btn-primary PalletOper" id="Pallet" onclick="makeAll('测试称重')" >打托</a>
						       </td>
					          </tr>					   
				         </table>
