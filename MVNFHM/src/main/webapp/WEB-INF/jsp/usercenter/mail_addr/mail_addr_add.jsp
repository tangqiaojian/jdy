		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="mail_addr/choose_save.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="text-align: center;" colspan="10">
									...
									<a class="btn btn-mini btn-danger" href="<%=basePath%>mail_addr/toChoose.do?M_TYPE=${pd.M_TYPE}">取消</a>
								</td>
							</tr>
						</table>
						</div>
				...
				if (flag == '1') {
			     ...
			     $("#Form").ajaxSubmit({
			          ...
			          success:function (data) {
			        	  if(data.flag){
			        		   window.location='<%=basePath%>mail_addr/toChoose.do?M_TYPE=${pd.M_TYPE}';
			                	//location.reload(); 
			                }else{
			                	layer.msg('提交失败', {
		                	        time: 2000, 
