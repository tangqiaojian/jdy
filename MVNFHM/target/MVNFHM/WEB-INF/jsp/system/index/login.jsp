...
<body>
	...
	<div style="width:100%;text-align: center;margin: 0 auto;position: absolute;">
		...
		<div id="loginbox" >
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright &copy; 万卓网络科技 2018</span></font>
				</div>
			</div>
		</div>
		</div>
		...
		<div id="loginbox" style="margin-top: 0px"><%--调整了间距--%>
			<form action="" method="post" name="loginForm" id="loginForm">
				<div class="control-group normal_text">
					<h3>
						<!-- <img src="static/login/logo.png" alt="Logo" /> -->
				...
				<div class="control-group" style="padding:15px 0 ;">
					<div class="controls">
						<div class="main_input_box">
							<span class="add-on bg_ly">
							<i>密码</i>
				...
				<div class="control-group" style="padding:15px 0 ;">
					<div class="controls">
						<div class="main_input_box">
							<span class="add-on bg_lg">
							<i>电话</i>
							</span><input type="text" name="PHONE" id="phone" value="" placeholder="请输入联系电话" />
						</div>
					</div>
				</div>
			    ...
			    <div class="control-group" style="padding:15px 0 ;">
					<div class="controls">
						<div class="main_input_box">
							...
							<select  class="select" name="CITY" id="city" data-placeholder="请选择">
							    <option value=""></option>
		...
		$.ajax({
			...
			success: function(data){
				 ...
				 $.each(data, function(i, dvar){
						$("#city").append("<option value="+dvar.STORE_ID+">"+dvar.S_NAME+"</option>");
				 });
 		   }
		});	
	});
	...
	function register(){
		if(rcheck()){
			...
			$.ajax({
		    	...
		    	data: {USERNAME:$("#USERNAME").val(),PASSWORD:$("#PASSWORD").val(),NAME:$("#name").val(),PHONE:$("#phone").val(),CITY:$("#city").val(),rcode:$("#rcode").val(),FKEY:$.md5('USERNAME'+nowtime+',fh,'),tm:new Date().getTime()},
				dataType:'json',
				cache: false,
				success: function(data){
					if("00" == data.result){
    ...
    $(function(){
    	$("#USERNAME").blur(function(){
    		$.ajax({
				type: "post",
				url: 'appSysUser/cheackUserName.do',
		    	data: {USERNAME:$("#USERNAME").val(),tm:new Date().getTime()},
				dataType:'json',
				cache: false,
				success: function(data){
					if(!data){
